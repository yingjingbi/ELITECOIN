...
int64 nChainStartTime = 1470033758;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 3000000000 * COIN;	// 1 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Aug 1,ELITECOIN start.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x56ebb882b28a8934cdcc30c97133d55b1c5d8ca87edf3abee28658106769706e"));
